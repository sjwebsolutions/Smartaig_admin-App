class MarksEntryClassDetailsModel {
  final bool success;
  final ClassDetailsData? data;

  MarksEntryClassDetailsModel({
    required this.success,
    this.data,
  });

  factory MarksEntryClassDetailsModel.fromJson(Map<String, dynamic> json) {
    return MarksEntryClassDetailsModel(

...
import 'package:smart_aig_admins_app/view_models/getX/exam_result_classes_controller.dart';
import 'package:smart_aig_admins_app/models/exam_result_classes_model.dart';

class ExamResultClassesScreen extends StatelessWidget {
  final int examId;
  final String examTitle;

  const ExamResultClassesScreen({
    super.key,
  ...
  Widget build(BuildContext context) {
    final ExamResultClassesController controller = Get.put(
      ExamResultClassesController(examId: examId),
      tag: "exam_result_$examId",
    );
  ...
  Widget _buildClassCard(BuildContext context, ClassData classData) {
    return Container(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () {
            // Next Step: Handle class selection for Results
          },
          borderRadius: BorderRadius.circular(15),
          child: Padding(
